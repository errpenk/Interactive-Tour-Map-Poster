// Map Constants
export const ITALY_CENTER = [42.50, 12.5];
export const MIN_ZOOM = 5;
export const MAX_ZOOM = 9;
export const ITALY_BOUNDS = [[35.0, 5.5], [48.0, 19.0]];
export const GEOJSON_URL = 'https://raw.githubusercontent.com/johan/world.geo.json/master/countries/ITA.geo.json';
